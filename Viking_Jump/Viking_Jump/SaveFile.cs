...
namespace Viking_Jump
{
    public static class SaveFile
    {
        ...
        private static Vector2 scorePosition = new Vector2(170, 370);
        private static Vector2 scoreFontSpace = new Vector2(0, 30);
        ...
        private static int nameArray = 0;
        private static int arrayLeangth = 5;
        ...
        public static void Draw(SpriteBatch spriteBatch)
        {
            ...
            else
            {
                ...
                for (int i = 0; i < arrayLeangth; i++)
                    // if score is more than 0 meters, then draw the score on screen | Julius 18-12-09
                    if (LoadData(Filename).Score[i] > 0)
                    {
                        ...
                        spriteBatch.DrawString(scoreFont, "Score: " + LoadData(Filename).Score[i] + " meters", scorePosition + (3 * i) * scoreFontSpace, Color.White);
                    }
            }
        }
